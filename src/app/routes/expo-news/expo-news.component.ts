...
@Component({
	selector: 'app-expo-news',
	templateUrl: './expo-news.component.html',
})
export class ExpoNewsComponent implements OnInit, OnDestroy {
	queryParams: any = {
		pi: 1,
		ps: 10,
		tag: 'article',
