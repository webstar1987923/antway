...
@Component({
	selector: 'app-expo-news-modal',
	templateUrl: './expo-news-modal.component.html',
})
export class ExpoNewsModalComponent implements OnInit, OnDestroy {
	data: any = {};
	expoes: any[] = [];
	tags: any[] = [];
