...
@Component({
	selector: 'app-lintel-list',
	templateUrl: './lintel-list.component.html',
})
export class LintelListComponent implements OnInit, OnDestroy {
	queryParams: any = {
		pi: 1,
		ps: 10,
		active: '',
	...
	getData() {
		...
		this.comSrv.getExpoLintels({ ...this.queryParams }).subscribe(
			(res: any) => {
				this.blkSrv.setBlockStatus(false);
				console.log('Lintel list', res);
	...
	openView(record: any = {}) {
		this.modal
			.create(LintelViewComponent, { data: { record } }, { size: 980 })
			.subscribe((res) => {
				this.getData();
			});
	}
